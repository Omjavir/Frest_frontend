...
const Product = () => {
    ...
    return (
        <div className='bg-emerald-200 pt-10 pb-10 text-blue-600 font-semibold border-b-blue-600 border-2 p-3 sm:p-14' id='products'>
            <div>
            ...
            <div className='flex flex-col sm:flex-row'>
                {products.map(prod => {
                    return <Link to={`product/${prod.id}`}><div className='border-blue-400 border-2 w-[35vh] mx-10 my-2' key={prod.id}>
